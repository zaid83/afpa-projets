...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 28 mars 2023 à 15:10
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `Signalements` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `validation` (`id_valid`, `etat`) VALUES
(1, 'Validé'),
(2, 'Non validé'),
...
ALTER TABLE `articles`
  ...
  ADD CONSTRAINT `articles_ibfk_2` FOREIGN KEY (`valid`) REFERENCES `validation` (`id_valid`);
